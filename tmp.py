...
def download_keys():
    ...
    if user_keys:
        ...
        # Provide download links for the keys using st.markdown
        st.markdown(get_download_link(decrypted_private_key, "private_key", "Download Private Key"), unsafe_allow_html=True)
        st.markdown(get_download_link(decrypted_public_key, "public_key.pub", "Download Public Key"), unsafe_allow_html=True)
